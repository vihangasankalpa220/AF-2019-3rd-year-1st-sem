...
class Navbar extends Component {
    ...
    render () {
        if(localStorage.usertoken){
            ...
            this.gravatar = 'https://www.gravatar.com/avatar/'+crypto.createHash('md5').update(decoded2.email).digest("hex");
        ...
        const adminMenu = (
            <ul className="navbar-nav">
                ...
                <li className="nav-item dropdown">
                    ...
                    <div className="dropdown-menu">
                        <Link to="/addinstructor" className="dropdown-item">
                            Add Instructor
                        </Link>
                        <Link to="#" className="dropdown-item">
                            Update Instructor
                ...
                <ul className="navbar-nav">
                    ...
                    {this.role==='admin' ? adminMenu :
                        this.role==='student' ? studentMenu :
                            this.role==='instructor' ? instructorMenu :
                                ''}
