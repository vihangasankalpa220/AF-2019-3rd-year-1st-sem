...
import React__default, { createContext, createElement, Component, useContext, useMemo, useCallback, cloneElement, useRef, useEffect, useLayoutEffect, Fragment, useState, forwardRef, memo, useDebugValue } from 'react';
...
var PickerToolbar = function (_a) {
  var children = _a.children,
      _b = _a.className,
      className = _b === void 0 ? null : _b,
      other = __rest(_a, ["children", "className"]);
...
var TimePickerToolbar = function (_a) {
  ...
  return createElement(PickerToolbar, {
  ...
  }, arrayIncludes(views, 'hours') && createElement(Fragment, null, createElement(ToolbarButton$1, {
    variant: "h2",
    onClick: function () {
  ...
  }), arrayIncludes(views, 'seconds') && createElement(Fragment, null, createElement(ToolbarText, {
    variant: "h2",
    label: ":",
    selected: false,
    className: classes.separator
    ...
    className: clsx(classes.ampmSelection, (_c = {}, _c[classes.ampmSelectionWithSeconds] = arrayIncludes(views, 'seconds'), _c))
  }, createElement(ToolbarButton$1, {
    disableRipple: true,
    variant: "subtitle1",
