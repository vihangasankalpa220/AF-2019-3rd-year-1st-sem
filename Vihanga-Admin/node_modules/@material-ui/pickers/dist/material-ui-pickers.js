...
var PickerToolbar = function (_a) {
  var children = _a.children,
      _b = _a.className,
      className = _b === void 0 ? null : _b,
      other = tslib_1.__rest(_a, ["children", "className"]);
...
var useStyles$7 = styles$5.makeStyles({
  container: {
    height: 300,
    overflowY: 'auto'
  }
...
var TimePickerToolbar = function (_a) {
  ...
  }, arrayIncludes(views, 'hours') && React.createElement(React.Fragment, null, React.createElement(ToolbarButton$1, {
    variant: "h2",
    onClick: function () {
  ...
  }), arrayIncludes(views, 'seconds') && React.createElement(React.Fragment, null, React.createElement(ToolbarText, {
    variant: "h2",
    label: ":",
    selected: false,
    className: classes.separator
